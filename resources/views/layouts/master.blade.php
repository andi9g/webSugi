    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('produk', []) }}" class="nav-link text-uppercase @yield('warnaproduk')">
          ...
          <li class="nav-item">
            <a href="{{ url('transaksi', []) }}" class="nav-link text-uppercase @yield('warnatransaksi')">
          ...
          <li class="nav-item">
            <a href="{{ url('dokter', []) }}" class="nav-link text-uppercase @yield('warnadokter')">
          ...
          <li class="nav-item">
            <a href="{{ url('chatingan', []) }}" class="nav-link text-uppercase @yield('warnachatingan')">
